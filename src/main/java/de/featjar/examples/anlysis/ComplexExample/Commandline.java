...
public class Commandline {
    ...
    private static String getPathFromResource(String resource) {
        ...
        File file = new File(Commandline.class.getClassLoader().getResource(resource).getPath());
        if (file == null) {
            try {
    ...
    public static void main(String[] args) {
        File file = new File(Commandline.class.getClassLoader().getResource("featuremodels/").getFile());
